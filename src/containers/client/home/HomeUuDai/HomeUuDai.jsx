    ...
    return (
      <div className='container' style={{height:'18rem',paddingTop: '2rem' }}>
        ...
        <Slider style={{}} {...settings}>
          ...
          <CustomSlide
            img={
              <img className='img__member img-fluid' style={{width: '90%'}}  src="./img-khuyenMai/big-star.jpg"  alt=""/>
            }
          />
          <CustomSlide
            img={
              <img className='img__member img-fluid' style={{width: '90%'}}  src="./img-khuyenMai/c'member.jpg"  alt="" />
            }
          />
          <CustomSlide
            img={
              <img className='img__member img-fluid' style={{width: '90%'}}  src="./img-khuyenMai/hssv.jpg"  alt=""/>
            }
          />
          <CustomSlide
            img={
              <img className='img__member img-fluid' style={{width: '90%'}}  src="./img-khuyenMai/c_ten.jpg"  alt=""/>
            }
          />
        </Slider>
      </div>
